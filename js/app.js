 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".mainpage-favorite__slider")) new Swiper(".mainpage-favorite__slider", {
            ...
            if (document.querySelector(".mainpage-works__slider")) new Swiper(".mainpage-works__slider", {
            ...
            if (document.querySelector(".mainpage-pets__slider")) new Swiper(".mainpage-pets__slider", {
            ...
            if (document.querySelector(".mainpage-zoos__slider")) new Swiper(".mainpage-zoos__slider", {
        ...
        replaceVideoPlaceholder(document.getElementById("video-panda"), "https://www.youtube.com/embed/dqT-UlYlg1s?si=aj3FLu9A6wIk6zrM&autoplay=1");
        replaceVideoPlaceholder(document.getElementById("video-eagle"), "https://www.youtube.com/embed/dUE_AMCliSU?si=JFY4l8Ev_qZRm2mV&autoplay=1");
        replaceVideoPlaceholder(document.getElementById("video-gorilla"), "https://www.youtube.com/embed/lut3lPe-V8M?si=eMnV1AcbS_BbDGO3&autoplay=1");
