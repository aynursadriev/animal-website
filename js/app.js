 ...
 */
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        if (inputCard.length) Array.from(inputCard).forEach((input => {
            ...
            input.addEventListener("input", (() => {
                ...
                input.setCustomValidity(value.length < input.minLength ? "Заполните поле" : "");
            }));
        }));
        ...
        if (inputCvc) {
            Inputmask({
                mask: "999",
                onincomplete: function() {
                    inputCvc.classList.add("_form-error");
                }
            }).mask(inputCvc);
            inputCvc.addEventListener("input", (() => {
                const value = inputCvc.value.replace(/\D/g, "");
                inputCvc.setCustomValidity(value.length < inputCvc.minLength ? "Заполните поле" : "");
            }));
        }
        const inputDonate = document.querySelector(".input-donate");
        if (inputDonate) Inputmask({
            alias: "numeric",
            prefix: "$",
            groupSeparator: ",",
            autoGroup: true,
        ...
        if (inputTel) {
            flsModules.inputmask = Inputmask({
                mask: "(999) 999-99-99",
                onincomplete: function() {
                    inputTel.classList.add("_form-error");
                }
            }).mask(inputTel);
            inputTel.addEventListener("input", (() => {
                const value = inputTel.value.replace(/\D/g, "");
                inputTel.setCustomValidity(value.length < inputTel.minLength ? "Заполните поле" : "");
            }));
        }
        const inputName = document.querySelectorAll(".input-name");
        if (inputName.length) flsModules.inputmask = new Inputmask({
            mask: "A{1,50}",
            placeholder: "",
            definitions: {
                A: {
        ...
        input.addEventListener("mouseleave", (() => {
            if (!input.matches(":focus")) input.placeholder = "E-mail";
        }));
        ...
        flsModules.tippy = tippy_esm(".first-flag", {
            content: document.querySelector("#tippy-one"),
            allowHTML: true,
            inertia: true,
        ...
        flsModules.tippy = tippy_esm(".second-flag", {
            content: document.querySelector("#tippy-two"),
            allowHTML: true,
            inertia: true,
            moveTransition: "transform 0.2s ease-out",
            offset: [ -125, 10 ],
        ...
        flsModules.tippy = tippy_esm(".third-flag", {
            content: document.querySelector("#tippy-three"),
            allowHTML: true,
            inertia: true,
            moveTransition: "transform 0.2s ease-out",
            offset: [ -125, 10 ],
        ...
        function initSliders() {
            if (document.querySelector(".mainpage-favorite__slider")) new core(".mainpage-favorite__slider", {
                modules: [ EffectCoverflow, Scrollbar, Pagination ],
                initialSlide: 1,
                autoHeight: true,
                observer: true,
                observeParents: true,
            ...
            if (document.querySelector(".mainpage-works__slider")) new core(".mainpage-works__slider", {
            ...
            if (document.querySelector(".mainpage-pets__slider")) new core(".mainpage-pets__slider", {
            ...
            if (document.querySelector(".mainpage-zoos__slider")) new core(".mainpage-zoos__slider", {
        ...
        function pageNavigation() {
            ...
            window.onload = function() {
                if (getHash()) {
                    ...
                    if (goToHash) setTimeout((() => {
                        document.querySelector(goToHash).scrollIntoView({
                            behavior: "smooth",
                            block: "start"
                        });
                    }), 0);
        ...
        function replaceVideoPlaceholder(videoPlaceholder, videoUrl) {
            if (videoPlaceholder !== null) videoPlaceholder.addEventListener("click", (function() {
                const iframe = document.createElement("iframe");
        ...
        replaceVideoPlaceholder(document.querySelector(".video-placeholder_first"), "https://www.youtube.com/embed/dqT-UlYlg1s?autoplay=1");
        replaceVideoPlaceholder(document.querySelector(".video-placeholder_second"), "https://www.youtube.com/embed/dUE_AMCliSU?autoplay=1");
        replaceVideoPlaceholder(document.querySelector(".video-placeholder_third"), "https://www.youtube.com/embed/lut3lPe-V8M?autoplay=1");
        const script_checkbox = document.querySelector(".dark-theme-btn");
        const script_elements = document.querySelectorAll(".header__wide, .menu, .header__logo, .menu__link, .icon-menu, .menu__body, .mainpage-works__wide, .mainpage-title, .mainpage-works__text, .swiper-scrollbar-drag_color, .swiper-pagination_color, .mainpage-mission__wide, .mainpage-mission__text, .mainpage-mission__title, .mainpage-pets__wide, .mainpage-opportunity__wide, .mainpage-opportunity__txt, .mainpage-opportunity__text, .mainpage-map__wide, .mainpage-zoos__wide, .mainpage-zoos__text, .mainpage-zoos__txt, .swiper-button-prev_custom, .swiper-button-next_custom");
        const script_image = document.querySelector(".mainpage-map__image");
        if (localStorage.getItem("darkThemeEnabled") === "true") {
            script_checkbox.checked = true;
            script_elements.forEach((element => {
                element.classList.add("dark-theme");
            }));
            if (script_image && script_image.src.includes("map.png")) script_image.src = "img/mainpage-map/map-dark-theme.png";
        }
        script_checkbox.addEventListener("click", (() => {
            script_elements.forEach((element => {
                element.classList.toggle("dark-theme");
            }));
            localStorage.setItem("darkThemeEnabled", script_checkbox.checked);
            if (script_image) if (script_image.src && script_image.src.includes("map.png")) script_image.src = "img/mainpage-map/map-dark-theme.png"; else script_image.src = "img/mainpage-map/map.png";
        }));
        window["FLS"] = false;
        isWebp();
        menuInit();
